...
let sec = '844bc49bc60be8cb698d6e9691326ea4b6d712fde2c352f5b1cc364de10043de'
let merc = 'M220614ZUXJ9113QA'
let sign = '8ed01dff23aea383b9147e537a3e8b94'
...
let links = `https://v1.apigames.id/transaksi/http-get-v1?merchant=${merc}&secret=${sec}&produk=ML${prodcid}&{prodcnya}&ref=AR${refer}`
var axios = require('axios');
var config = {
  method: 'get',
  url: `https://v1.apigames.id/merchant/${global.merchant}/cek-username/mobilelegend?user_id=${prodcnya}&signature=${sign}`,
  headers: { }
};
...
var config = {
  method: 'get',
  url: `https://v1.apigames.id/transaksi/http-get-v1?merchant=${merc}&secret=${sec}&produk=ML${prodcid}&tujuan=${prodcnya}&ref=${refer}`,
  headers: { }
};
